...
public class UserService implements IUserDao {
    ...
    public boolean addUser(User user) {
        ...
        try {
            ...
            ps.setString(4, user.getSecurityAnswer()); // Réponse secrète en clair
    ...
    public boolean resetPasswordBySecurityQuestion(String login, String securityAnswer) {
        try {
            ...
            if (user != null) {
                ...
                PreparedStatement ps = connexion.getCn().prepareStatement(req);
                ps.setString(1, login);
                ps.setString(2, securityAnswer); // Réponse secrète en clair
                ResultSet rs = ps.executeQuery();
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Réponse secrète incorrecte.");
                }
            } else {
    ...
    public boolean updatePassword(String login, String newPassword) {
        ...
        try {
            ...
            System.out.println("Erreur lors de la mise à jour du mot de passe : " + e.getMessage());
        }
        return false;
    }
    ...
    private void sendPasswordByEmail(String recipientEmail, String newPassword) {
        try {
            String username = "a.essayouti3047@uca.ac.ma"; //ma  adresse e-mail
            String password = "zbqg knms erih sqxq"; // j'ai creer un  mot de passe de l'application
            ...
            message.setSubject("Réinitialisation de votre mot de passe");
            message.setText("Votre nouveau mot de passe est : " + newPassword);

            Transport.send(message);
            JOptionPane.showMessageDialog(null, "Un nouveau mot de passe a été envoyé à votre adresse e-mail.");
